...
[_QWERTY] = LAYOUT_ortho_4x12(
  ...
  KC_CLCK, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______, KC_LCTL, KC_LALT, _______, _______, _______, _______, _______,    KC_PGUP,    KC_HOME, KC_END, KC_DOWN
),
